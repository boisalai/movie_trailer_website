...
prisoners = media.Movie(
    "Prisoners (2013 film)",
    "Prisoners is a 2013 American thriller film directed by Denis Villeneuve "
        + "from a screenplay written by Aaron Guzikowski. The film has an "
        + "ensemble cast including Hugh Jackman, Jake Gyllenhaal, Viola Davis, "
        + "Maria Bello, Terrence Howard, Melissa Leo and Paul Dano.",
    "https://upload.wikimedia.org/wikipedia/en/6/63/Prisoners2013Poster.jpg",
    "https://www.youtube.com/watch?v=KWhS0xN3C0g")

enemy = media.Movie(
    "Enemy (2013 film)",
    "Enemy is a 2013 psychological thriller film directed by Denis Villeneuve, "
        + "produced by M.S. Faura and Niv Fichman and written by Javier Gullón, "
        + "loosely adapted from José Saramago's 2002 novel The Double.",
    "https://upload.wikimedia.org/wikipedia/en/0/0d/Enemy_poster.jpg",
    "https://www.youtube.com/watch?v=FJuaAWrgoUY")

sicario = media.Movie(
    "Sicario (2015 film)",
    "Sicario is a 2015 American crime-drama film directed by Denis Villeneuve, "
        + "written by Taylor Sheridan, and starring Emily Blunt, Benicio del "
